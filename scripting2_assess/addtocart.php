...
header("Location: online_shop.php"); exit;
} else {
//get info
...
(session_id, sel_item_id, sel_item_qty, sel_item_size, sel_item_color, date_added) VALUES 
('".$_COOKIE['PHPSESSID']."',
'".$safe_sel_item_id."', '".$safe_sel_item_qty."', '".$safe_sel_item_size."', 
...
header("Location: showcart.php"); exit;
}

...
if ((!$_POST['category_id']) || (!$_POST['topic_owner']) || (!$_POST['topic_title']) ||
(!$_POST['post_text'])) { 
...
(topic_id, post_text, post_create_time, post_owner) VALUES ('".$topic_id."', '".$clean_post_text."',now(), '".$clean_topic_owner."')";
...
<a href="topiclist.php">Check forum!!</a>

...
//validate item
$get_item_sql = "SELECT c.id as cat_id, c.cat_title, si.item_title, si.item_price, si.item_desc, si.item_image, si.item_stock 
...
<strong><a href="online_shop.php?cat_id=$cat_id">$cat_title</a> &gt;
$item_title</strong></p>
<div style="float: left;"><img src="imgs/$item_image" width="200" height="200" alt="$item_title"
/></div>
...
//get colors
$get_colors_sql = "SELECT item_color FROM store_item_color 
...
//get qty
$get_qty_sql ="SELECT item_stock FROM store_items ";

$get_qty_res =mysqli_query($mysqli,$get_qty_sql)
or die(mysqli_error($mysqli));

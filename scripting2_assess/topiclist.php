...
DATE_FORMAT(topic_create_time,  '%b %e %Y at %r') AS fmt_topic_create_time, topic_owner 
...
//get number of posts
$get_num_posts_sql = "SELECT COUNT(post_id) AS post_count FROM forum_posts WHERE topic_id = 
'".$topic_id."'";
